...
function ProfilDosen() {
  return (
    ...
    <NavBarHome/>
    <div>
        <label className='d-flex justify-content-center mt-4 h3 fw-bold'>Dosen Program Studi Sistem Informasi</label>
        <label className='d-flex justify-content-center mt-1 h5 fw-bold'>Institut Pendidikan Indonesia Garut</label>
    ...
    <Row>
        ...
        <Card.Body>
        <Card.Title className='fw-bold'>Yopi Nugraha, M.Kom</Card.Title>
        <Card.Text className='nidn'>
       NIDN : 0412029202 
        </Card.Text>
        <Card.Text className='nidn2'>Kepala Program Studi Sistem Informasi Institut Pendidikan Indonesia</Card.Text>
      </Card.Body>
      <Card.Footer>
        <Row className='justify-content-md-center' xs='auto'>
         ...
         <Col>
         <NavLink to="https://www.facebook.com/profile.php?id=100077447298996" target='_blank'>
          ...
          <Col>
          <NavLink to="https://www.instagram.com/yopi_nugraha/" target='_blank'>
    ...
    <Card style={{ width: '20rem'}}>
      ...
      <Card.Body>
        <Card.Title className='fw-bold'>Sukrina Herman, M.Kom</Card.Title>
        <Card.Text className='nidn'>
       NIDN : 0402069501
        </Card.Text>
        <Card.Text className='nidn2'>Dosen Program Studi Sistem Informasi Institut Pendidikan Indonesia</Card.Text>
      </Card.Body>
      <Card.Footer>
        <Row className='justify-content-md-center' xs="auto">
    ...
    <Card style={{ width: '20rem' }}>
      ...
      <Card.Body>
        <Card.Title className='fw-bold'>Dinar Rahayu, M.Kom</Card.Title>
        <Card.Text className='nidn'>
       NIDN : 0412109007
        </Card.Text>
        <Card.Text className='nidn2'>Dosen Program Studi Sistem Informasi Institut Pendidikan Indonesia</Card.Text>
    ...
    <Col>
        ...
        <Card.Img src={Elin}/>
        <Card.Body>
        <Card.Title className='fw-bold'>Dr. Elin Rosliani, M.Kom</Card.Title>
        <Card.Text className='nidn'>
       NIDN : 0428037803 
        </Card.Text>
        <Card.Text className='nidn2'>
        Dosen Program Studi Sistem Informasi Institut Pendidikan Indonesia
        </Card.Text>
    ...
    <Card style={{ width: '20rem' }}>
      ...
      <Card.Body>
        <Card.Title className='fw-bold'>Tedi Budiman, M.Kom</Card.Title>
        <Card.Text className='nidn'>
       NIDN : 0410067601
        </Card.Text>
